...
interface CreateCADialogProps {
  ...
  onSuccess?: (data: CreateCAFormValues) => void;
}

export function CreateCADialog({ trigger, onSuccess }: CreateCADialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure a new Certificate Authority for your organization
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
